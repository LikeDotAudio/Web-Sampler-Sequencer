...
window.OA_BUILD_STAMP="98ba685f4a12d833";
(function(){"use strict";
...
window.Pad = ({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    const waveLoaded = isToneMode ? !!(window.OA_DRUM_SAMPLES && window.OA_DRUM_SAMPLES[toneRoot] && window.OA_DRUM_SAMPLES[toneRoot].buffer) : hasSample;
    return waveLoaded ? /*#__PURE__*/React.createElement(PadWave, {
      idx: waveIdx,
