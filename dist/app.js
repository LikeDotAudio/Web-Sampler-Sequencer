...
window.OA_BUILD_STAMP="6fae338cff22225d";
(function(){"use strict";
...
window.SeqSong = ({
  ...
  const importFile = file => {
    ...
    reader.onload = () => {
      ...
      window.alert(`Imported ${parsed.patterns.length} pattern(s)` + (parsed.song.length ? ` and a ${parsed.song.length}-part song.` : '.') + note);
    };
